  ...
  return (
    <>
      <div className='flex flex-col gap-1'>
        <a className='dark:bg-yellow-400 bg-yellow-400 p-3 rounded-sm gap-2 self-center flex flex-col items-center dark:text-gray-800 text-gray-800 w-44 place-content-center cursor-pointer' href={getLink()} onClick={() => trackEvent()}>
          {platform === 'darwin' &&
            <>
          ...
          {platform === 'win' &&
            <>
              <svg viewBox='0 0 384 512' width='32'>
                <path fill='currentColor' d='M0,93.7l183.6,-25.3v177.4h-183.6v-152.1Zm0,324.6l183.6,25.3v-175.2h-183.6v149.9Zm203.8,28l244.2,33.7v-211.6h-244.2v177.9Zm0,-380.6v180.1h244.2v-213.8l-244.2,33.7Z' />
              </svg>
        ...
        {platform === 'linux' &&
          <div className='grid grid-cols-2 text-xs gap-1 text-gray-800 dark:text-gray-800'>
            <a className='dark:bg-yellow-400 bg-yellow-400 text-center p-2' href={getLink('deb')}>.deb</a>
            <a className='dark:bg-yellow-400 bg-yellow-400 text-center p-2' href={getLink('rpm')}>.rpm</a>
          </div>}
      </div>
    </>
  )
